...
function dashboard(id, fData) {
	...
	function segColor(c) {
		return {handguns:"#807dba", rifles:"#e08214",shotguns:"#41ab5d"}[c];
	}

	// compute total for each state.
	fData.forEach(function(d) {
		d.total = d.freq.handguns + d.freq.rifles + d.freq.shotguns;
	});
	...
	var tF = ['handguns', 'rifles', 'shotguns'].map(function(d) {
		return {
			type : d,
